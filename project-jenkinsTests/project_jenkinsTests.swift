...
class project_jenkinsTests: XCTestCase {
    ...
    func testValidEmail() {
        let value = "max@example.com"
        XCTAssert(value.isValidEmail() == true, "not a valid email address.")
    }
    
    func testInvalidEmail() {
        let value = "maxexample.com"
        XCTAssert(value.isValidEmail() == false, "test failed for invalid email address.")
    }
